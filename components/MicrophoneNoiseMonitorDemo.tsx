    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
              ...
              {(["bars", "circle", "pulse"] as const).map((variant) => (
                <label key={variant} className="flex items-center">
                  <input
                    ...
                    value={variant}
                    onChange={(e) =>
                      setCurrentVariant(e.target.value as typeof currentVariant)
                    }
                  />
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
        ...
        <div className="space-y-3 text-sm text-blue-800 dark:text-blue-200">
          <p>
            1. <strong>Enable Microphone:</strong> Click the "Enable Microphone"
            button and allow access when prompted
          </p>
          <p>
            2. <strong>Start Listening:</strong> Click "Start Listening" to
            begin audio monitoring
          </p>
          <p>
            3. <strong>Visual Feedback:</strong> The indicator will show your
            audio level in real-time
          </p>
          <p>
            4. <strong>Mute/Unmute:</strong> Use the mute button or press 'M'
            key to toggle microphone
          </p>
          <p>
            5. <strong>Customize:</strong> Adjust sensitivity and visualization
            style using the controls above
          </p>
        </div>
      </div>
    </div>
