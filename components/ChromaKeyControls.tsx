        ...
        <div className="mt-3 space-y-3">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleOptionChange("whiteThreshold", parseFloat(e.target.value))
              }
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleOptionChange("tolerance", parseFloat(e.target.value))
              }
            />
            <div className="text-xs text-gray-400">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleOptionChange("smoothing", parseFloat(e.target.value))
              }
            />
            <div className="text-xs text-gray-400">Edge smoothing strength</div>
          </div>
