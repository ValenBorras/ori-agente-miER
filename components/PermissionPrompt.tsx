...
export function PermissionPrompt({
  ...
  if (!isSupported) {
    return (
      <div className={`flex flex-col items-center gap-4 p-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800 ${className}`}>
        <div className="flex items-center gap-2 text-yellow-700 dark:text-yellow-300">
          <MicIcon size={20} />
          <span className="font-medium">Browser Not Supported</span>
        </div>
        <p className="text-sm text-yellow-600 dark:text-yellow-400 text-center">
          Your browser doesn't support the Web Audio API required for microphone access. 
  ...
  if (error) {
    return (
      <div className={`flex flex-col items-center gap-4 p-6 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800 ${className}`}>
  ...
  return (
    <div className={`flex flex-col items-center gap-4 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 ${className}`}>
      ...
      <p className="text-xs text-blue-500 dark:text-blue-400 text-center">
        Your microphone will only be used for this conversation and won't be recorded or stored.
      </p>
    </div>
  );
} 